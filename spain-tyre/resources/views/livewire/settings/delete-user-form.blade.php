    ...
    <flux:modal name="confirm-user-deletion" :show="$errors->isNotEmpty()" focusable class="max-w-lg">
        <form wire:submit="deleteUser" class="space-y-6">
            <div>
                ...
                <flux:subheading>
                    {{ __('Una vez que tu cuenta sea eliminada, todos sus recursos y datos serán borrados de forma permanente. Por favor, introduce tu contraseña para confirmar que deseas eliminar tu cuenta definitivamente.') }}
                </flux:subheading>
            </div>
